...
# linking it under the next dotted key -- the same pattern the pod driver (tonton
# work/h3edit_pod.py, H3_ADDNODES/H3_APISET) validated on a 5090. Nothing is typed by hand.
MAX_REFS = 5
# Default lane (bench 2026-09-09, tonton truck-hero, seed 1001, 5 refs): PlagueKind Parasyte turbo at
